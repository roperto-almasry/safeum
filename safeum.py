...
def create():
    ...
    data0 = {"action": "Register", "subaction": "Desktop", "locale": "en_GB", "gmt": "+02",
             ...
             "login": str(user), "devicename": "Xiaomi Redmi Note 8 Pro", "softwareversion": "1.1.0.1380",
             "nickname": "hvtctchnjvfxfx", "os": "AND", "deviceuid": "c72d110c1ae40d50",
             "devicepushuid": "*dxT6B6Solm0:APA91bHqL8wxzlyKHckKxMDz66HmUqmxCPAVKBDrs8KcxCAjwdpxIPTCfRmeEw8Jks_q13vOSFsOVjCVhb-CkkKmTUsaiS7YOYHQS_pbH1g6P4N-jlnRzySQwGvqMP1gxRVksHiOXKKP", "osversion": "and_11.0.0",
             "id": "5413631898"}

    ws = websocket.create_connection("wss://51.79.208.190/Auth", header=headers,
